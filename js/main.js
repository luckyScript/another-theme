function otherFunction(){
    ...
    $(".navbar-btn").click(function() {
        ...
        $(".navbar-top").removeClass("navbar-top-move");
		$(".navbar-btn").removeClass("navbar-btn-move");
    });
	...
	$(window).scroll(function() {
		...
		if($(window).scrollTop() > 20) {
			$(".navbar-top").addClass("navbar-top-move");
			$(".navbar-btn").addClass("navbar-btn-move");
		}else {
			$(".navbar-top").removeClass("navbar-top-move");
			$(".navbar-btn").removeClass("navbar-btn-move");
		}
